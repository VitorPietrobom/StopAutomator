...
def get_words_from_gpt(letter: str = None, categorys: list = None):
    ...
    prompt = "Faca uma lista em python com palavras iniciadas em {0}, a lista deve conter uma palavra para cada tema da seguinte lista:{1}, por favor mantenha na ordem dos temas, retorne apenas a lista e mais nada".format(letter, categorys)
